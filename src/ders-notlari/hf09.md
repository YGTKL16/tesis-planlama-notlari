...
!!! example "\1"
> | Bölüm | Alan (m²) | Tek banttaki uzunluk $\ell_i = A_i/w$ |
> |---|---:|---:|
> | A | 30 | 10 m |
> | B | 45 | 15 m |
> | C | 51 | 17 m |
...
- Bölüm sayısıyla **üstel** artan değişim alternatifi; çok katlı planlamaya olanak.
...
> | Çift | İlişki | $w_{ij}$ | $d_{ij}$ | $w_{ij}d_{ij}$ |
> |---|---|---:|---:|---:|
> | D1-D2 | A | 10 | 3 | 30 |
> | D1-D4 | E | 5 | 5 | 25 |
> | D2-D4 | I | 2 | 8 | 16 |
...
- \1 — süpürme paterni, bant genişliği, ikili değişim ve maliyet
- \1 — toplam akış, A/E/I/O/U/X dönüşümü, $Z_A$ / $ER$ / $RD$
- \1 — giyotin kesim, kesim ağacı, yaprak değişimi
