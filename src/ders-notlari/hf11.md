...
- \1 — ağırlıklı medyan algoritması, eşit yarı/optimum aralık, eş maliyet eğrileri ve kademeli alıştırmalar.
- \1 — $u$-$v$ dönüşümü, $R^\*$, optimum doğru parçası ve geri dönüşüm tuzakları.
- \1
- \1
- \1
- \1
